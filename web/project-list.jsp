        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
            ...
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="projectListAction.action">
                            ...
                            <div class="card-body p-0 pb-3 text-center">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0">projectName</th>
                                        <th scope="col" class="border-0">projectUrl</th>
                                        <th scope="col" class="border-0">operate</th>
                                    </tr>
                                    </thead>
                                    <c:forEach items="${programs}" var="program">
                                        ...
                                        <tr>
                                            ...
                                            <td onclick="window.location.href = 'deleteProjectAction.action?id=${program.id}'">É¾³ý</td>
                                        </tr>
                                        </tbody>
                                    </c:forEach>
